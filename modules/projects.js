export const projects = [{
  ...
  desc: {
    en: "An online (remote) version of the CODENAME game. It supports 4 players and several viewers.",
    es: "Una versión remota y en línea del juego CODENAME. Pueden jugar 4 personas más la audiencia.",
  },
  tags: [
    "game",
    "code",
