...
export const PAGES = {
  ...
  BIO: {
    section: {
      style: STYLE.PAGE,
      content: [{
          p: ["Lenino is a storyteller, an explorer of sience, technology and arts who was born in the Caribbean and has lived in New York City all his “adult” life. His studies range from telecommunications engineering and interactive media to cognitive studies in education. His trainings range from acting and scriptwriting to modern dance and vocals. He is a self-taught piano player and a self-professed nerd—a post-modern renaissance man.",
